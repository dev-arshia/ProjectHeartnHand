...
// Wipe existing report/match/audit data so re-running this script gives a
// clean, predictable demo state. Leaves the admins table alone.
db.exec('DELETE FROM audit_log');
db.exec('DELETE FROM matches');
db.exec('DELETE FROM reports');
db.exec("DELETE FROM sqlite_sequence WHERE name IN ('reports','matches','audit_log')");
